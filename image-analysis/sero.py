...
def main():
    ...
    if dePickle:
        ...
        plotBlob3ds(all_gen_b3ds, color='depth')
        print('Plotting ALL b3ds')
        plotBlob3ds(blob3dlist + all_gen_b3ds, color='blob')
        plotBlob3ds(blob3dlist + all_gen_b3ds, color='depth')
