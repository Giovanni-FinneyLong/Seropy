...
class config:
    ...
    min_val_threshold = 250 # The minimal value (out of 255) that a pixel must be to be considered 'on'
                            # Using a higher value will have a tendency to preserve the general shape of a blob2d
                            # Using a lower value will have a tendency to preserve the fringes of each blob2d, while also making them slightly larger
                            # Recommended = 250
